...
export default function header() {
  return (
    ...
    <div className='mainHeader'>
        <img style={{width:"32rem",height:"32rem"}} src='https://cdn.discordapp.com/attachments/1022933125107548242/1022946802430906490/Logo_Final_Plan_de_travail_1.png'></img>
    </div>
    <div id='headerMenu'>
      <Link href='/'>
